...
<head>
	...
	<title><?php echo $this->title; ?></title>
        ...
        <form id="formAlbum" class="formularios forms" action="<?php echo _URL; ?>Album/crear" method="POST" enctype="multipart/form-data">
        ...
        <button id="btnAddArts" onclick="fcnAddArtista()">Añadir otro Artista</button>
        <script>
