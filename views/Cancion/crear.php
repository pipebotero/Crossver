...
<head>
	...
	<title><?php echo $this->title; ?></title>
        ...
        <form class="formularios forms" action="<?php echo _URL; ?>Cancion/crear" method="POST" enctype="multipart/form-data">
            <input name="nombreCancion" type="text" placeholder="Canción" >
			...
			<option value="">Seleccione Artista</option>
                   ...
                   <input name="year" type="text" placeholder="Año" >
